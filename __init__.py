...
# add a vonsole.print for days_elapsed..
                ...
                if period!=-1:
                    ...
                    table.add_column('x_coord',style='Cyan')
                    table.add_column('y_coord',style='magenta')
                    ...
                    for day in range(period+1):
                        ...
                        table.add_row(f'{day}',f'{mean_anomaly}',f'{x_coord}',f'{y_coord}')
